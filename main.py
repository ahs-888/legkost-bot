...
START_TEXT = (
    "Если внутри есть напряжение и оно не даёт покоя.\n\n"
    "Если накрывает тревога, злость, страх, пустота или боль.\n\n"
    "Здесь есть простой способ прожить это и отпустить.\n\n"
    "Два упражнения. Без анализа. Без терапии."
)
